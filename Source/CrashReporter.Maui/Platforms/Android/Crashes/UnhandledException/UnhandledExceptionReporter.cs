...
internal class UnhandledExceptionReporter(ILogger<UnhandledExceptionReporter> _logger) : ICrashReporter
{
    ...
    private void AndroidEnvironment_UnhandledExceptionRaiser(object? sender, RaiseThrowableEventArgs e)
    {
        ...
        var crash = UnhandledExceptionCrash.FromException(e.Exception);
